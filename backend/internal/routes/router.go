...
func SetupRoutes(app *app.Application) *chi.Mux {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/team-members/{memberID}/scheduling-profile/", app.RosterHandler.SchedulingProfile)
		r.Put("/team-members/{memberID}/scheduling-profile/", app.RosterHandler.SchedulingProfile)
		r.Get("/rosters/{week}/", app.RosterHandler.Roster)
		r.Put("/rosters/{week}/", app.RosterHandler.Roster)
		r.Post("/rosters/{week}/draft/", app.RosterHandler.DraftRoster)
